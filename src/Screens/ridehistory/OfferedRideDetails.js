      ...
      <View style={{width: '90%', marginTop: 5}}>
        <Text
          ...
          <Text
            ...
            {'(' +
              rideData[0].seat_left +
              ' out of ' +
              rideData[0].seat_available +
              ' seats available' +
              ')'}
          </Text>
        </Text>
              ...
              <View
                ...
                <Text
                  style={{
                    ...
                    fontFamily: AppFontFamily.PopinsBold,
                    fontSize: 13,
                    color: AppColors.themeButtonRed,
                  }}>
                  {rideData[0].status.toUpperCase()}
                </Text>
              </View>
            ) : null}
          </View>
                ...
                <View
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {rideData[0].journey_origin_address}
                    </Text>
                  </View>
                </View>
                ...
                <View
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {rideData[0].journey_destination_address}
                    </Text>
                  </View>
                </View>
              </View>
            ...
            <View style={{justifyContent: 'flex-start', width: '50%'}}>
              ...
              <Text
                ...
                {CalculateTimeFromMilies(
                  Number(rideData[0].journey_approx_time),
                )}
              </Text>
            </View>
    ...
    return (
      <>
        ...
        <View
          ...
          <Pressable
            onPress={() => cancelAlert(rideData[0])}
            style={{
              backgroundColor: AppColors.themesWhiteColor,
              borderRadius: 5,
              alignItems: 'center',
