...
export default function KycScreen({navigation}) {
  const [doc, setDoc] = React.useState([
    {index: 0, name: 'Aadhar Card', type: 'Aadhar Number'},
    {index: 1, name: 'Driving Licence', type: 'Driving Licence Number'},
    {index: 2, name: 'Passport', type: 'Passport Number'},
  ]);
        ...
        <View
          ...
          <Pressable
            ...
            <View
              ...
              <Image
                source={require('../../assets/driverslicense.png')}
                style={{width: 30, height: 20, resizeMode: 'contain'}}
              />
              <Text
                style={{
