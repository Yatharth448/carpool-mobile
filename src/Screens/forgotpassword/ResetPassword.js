      ...
      <View style={{width: '100%', alignItems: 'center'}}>
        <View style={{width: '90%', justifyContent: 'center'}}>
          ...
          <InputView
            ...
            right={showNewPassword ? 'eye-off-outline' : 'eye-outline'}
          ...
          <InputView
            ...
            right={showConfirmPassword ? 'eye-off-outline' : 'eye-outline'}
          ...
          <View style={{alignItems: 'center', marginTop: 30}}>
            <ButtonPrimary
              text={'Submit'}
              onPress={() =>
                isLoading ? console.log('already clicked') : resetOTP()
              }
              loader={isLoading}
            />
          </View>
