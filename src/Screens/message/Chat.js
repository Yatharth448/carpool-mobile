...
import { View, Text, RefreshControl, Image, FlatList, Dimensions, TextInput, Pressable, StyleSheet, Linking } from 'react-native'
    ...
    const TopHeader = () => {
        return (
            <View style={{ backgroundColor: AppColors.themesWhiteColor, height: 70, width: '100%', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center' }}>
                ...
                <Pressable onPress={() => Linking.openURL(`tel:${phone}`)} style={{ width: '25%', height: 50, alignItems: 'flex-end', paddingRight: 20, justifyContent: 'center' }}>
