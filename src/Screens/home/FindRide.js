...
import { GetCurrentLocation, checkLocationPermission, getCurrentLocationFromLatLong, locationAlert } from "../../components/location/GetCurrentLocation";
...
class FindRide extends Component {
    ...
    searchRide = async () => {
        ...
        if (!this.state.pickupLocation) {
            ...
            Toast.show('Select pickup location');
        }
        else if (!this.state.dropLocation) {

            Toast.show('Select drop location');
        }
            ...
            Toast.show('Select no of passengers');
        }
        else {
    ...
    procced = async () => {
        ...
        if (!this.state.pickupLocation) {
            ...
            Toast.show('Select your vehicle');
        }
        else if (!this.state.avilSeat) {

            Toast.show('Select no of seats available');
        }
        else {
