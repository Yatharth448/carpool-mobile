...
import {
  ...
  showNotification,
} from '../../components/notifications/LocalNotification';
...
class FindRide extends Component {
    ...
    if (!this.state.pickupLocation) {
      ...
      if (this.props?.data?.kyc_status == 1) {
        ...
        Toast.showWithGravity(
          'Your kyc is under review, please wait some time or contact us',
          2,
          Toast.TOP,
        );
      }
  ...
  onViewClick() {
    if (this.state.existingData?.multi) {
      ...
      const from = this.state.existingData?.from;
      this.props.navigation.navigate(this.state.existingData?.screenname, {
      ...
      <>
        ...
        <View
          ...
          <View style={{alignItems: 'center', width: '96%', marginTop: 0}}>
            ...
            <AvtarView
              image={require('../../assets/avtar.png')}
              name={name}
      ...
      <>
        ...
        <View
          ...
          <Header
            ...
            rightClick={() => showNotification({title: 'hi', message: 'hello'})}
          />
        </View>
    ...
    return (
      <View style={{flex: 1, alignItems: 'center'}}>
        {this.state.kycStatus == 0 ? (
          <PendingKYC
            message={'Your kyc is pending, Please update your kyc'}
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <this.HeaderView name={data?.name ?? ''} gender={data?.gender} />
          }
